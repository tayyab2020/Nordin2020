...
Route::group(['middleware' => 'App\Http\Middleware\UserTypeMiddleware'], function()
{
    Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
        ...
        Route::get('faqs/addfaqbanner', 'DashboardController@addeditfaqbanner');
        Route::post('faqs/addfaqbanner', 'DashboardController@addnewfaqbanner');
    ...
    Route::get('details', 'IndexController@Appointment');

    Route::post('details', 'IndexController@PostAppointment');
