    ...
    <div class="tab-content tab-content-default">
        <div role="tabpanel" class="tab-pane active" id="account">
            {!! Form::open(array('url' => 'admin/settings','class'=>'form-horizontal padding-15','name'=>'account_form','id'=>'account_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Contact Page Heading</label>
                    <div class="col-sm-9">
                        <textarea name="contact_heading" rows="10" class="form-control summernote">{{ isset($settings->contact_heading) ? $settings->contact_heading : null }}</textarea>
                    </div>
                </div>
                <div class="form-group">
